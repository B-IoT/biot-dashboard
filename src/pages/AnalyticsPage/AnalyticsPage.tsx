      ...
      <div className="glass side-bar">
        <div className="side-bar-top">
          ...
          <div className="selected-page">
            <img
              className="page-icon"
              src={'/img/analyticsIconWhite.svg'}
              alt="analytics icon"
            />
          ...
          >
            <img
              className="page-icon"
              src={'/img/inventoryIconBlue.svg'}
              alt="inventory icon"
            />
            <div className="axiforma-regular-normal-blue-16px">
              {strings.inventory}
            </div>
          </Link>
        </div>
        ...
        <div className="side-bar-bottom">
          <div className="utils-container">
            <img
              ...
              src={'/img/user-cog.png'}
              alt="parameters icon"
            />
            <div className="utils-text axiforma-regular-normal-trout-16px">
              {'Paramètres'}
            </div>
          </div>
          ...
          <div className="utils-container">
            <img
              className="utils-icon"
              src={'/img/life-ring.png'}
              alt="assistance icon"
            />
            <div className="axiforma-regular-normal-trout-16px">
              {'Assistance'}
            </div>
          </div>
      ...
      <div className="widgets">
        <div className="cheese-graph glass">
          ...
          <div className="group-96">
            <div className="disponible2 axiforma-regular-normal-eerie-black-16px">
              {'Disponible'}
            </div>
            <div className="indisponible2 axiforma-regular-normal-eerie-black-16px">
              {'Indisponible'}
            </div>
            <div className="dfectueux2 axiforma-regular-normal-eerie-black-16px">
              {'Défectueux'}
            </div>
        ...
        <div className="mask-group-12 hidden ">
          <div
            className="group-64"
            style={{ backgroundImage: '/img/banner-1@1x.png' }}
          >
        ...
        <div className="group-97">
          <div className="graph">
            <div className="dates">
              <div className="aug-2018 axiforma-regular-normal-trout-16px">
                {'Sep 2020'}
              </div>
              <div className="sep-2018 axiforma-regular-normal-trout-16px">
                {'Oct 2020'}
              </div>
              <div className="oct-2018 axiforma-regular-normal-trout-16px">
                {'Nov 2020'}
              </div>
              <div className="nov-2018 axiforma-regular-normal-trout-16px">
                {'Dec 2020'}
              </div>
              <div className="dec-2018 axiforma-regular-normal-trout-16px">
                {'Jan 2021'}
              </div>
            </div>
          ...
          <div className="date-range">
            ...
            <div className="from axiforma-regular-normal-trout-16px">
              {'de'}
            </div>
          ...
          <div className="y-axis">
            <div className="number2 axiforma-regular-normal-trout-12px">
              {'15'}
            </div>
            <div className="number-12 axiforma-regular-normal-trout-12px">
              {'10'}
            </div>
            <div className="number-22 axiforma-regular-normal-trout-12px">
              {'5'}
            </div>
            <div className="number-32 axiforma-regular-normal-trout-12px">
              {'0'}
            </div>
          </div>
          <div className="lines">
          ...
          <div className="text-1 axiforma-extra-bold-eerie-black-20px">
            {'Évolution de la maintenance'}
          </div>
          <div className="text-2 axiforma-regular-normal-eerie-black-16px">
            {'Pourcentage de matériel défectueux'}
          </div>
        </div>
        <div className="group-98">
          <div className="tat-des-services axiforma-extra-bold-eerie-black-20px">
            {'État des services'}
          </div>
          <div className="oct-2018-1 axiforma-regular-normal-trout-16px">
            {'Bloc 1'}
          </div>
          <div className="nov-2018-1 axiforma-regular-normal-trout-16px">
            {'Bloc 2'}
          </div>
          ...
          <div className="component-6-1">
            ...
            <div className="dfectueux-1 axiforma-regular-normal-eerie-black-16px hidden ">
              {'Défectueux'}
            </div>
          ...
          <div className="component-4-1">
            ...
            <div className="dfectueux-2 axiforma-regular-normal-eerie-black-16px hidden ">
              {'Défectueux'}
            </div>
          </div>
          <div className="component-3-1">
            <div className="indisponible-12 axiforma-regular-normal-eerie-black-16px hidden ">
              {'Indisponible'}
            </div>
          ...
          <div className="component-2-1">
            <div className="component-1-1">
              <img
                className="subtraction-1"
                src={'/img/subtraction-1@1x.png'}
              />
            </div>
            <div className="percent-72 axiforma-bold-white-16px">{'57%'}</div>
            <div className="disponible-12 axiforma-regular-normal-white-16px hidden ">
              {'Disponible'}
            </div>
          </div>
          <div className="component-5-1">
            ...
            <div className="disponible-22 axiforma-regular-normal-white-16px hidden ">
              {'Disponible'}
            </div>
          </div>
        </div>
        ...
        <Exclusion1
          exclusion1={'/img/exclusion-1@1x.png'}
          className="exclusion-2"
        />
